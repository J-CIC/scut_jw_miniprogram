...
Page({
    ...
    submitForm: function(e) {
        ...
        "" != t && "" != o ? (wx.getStorageSync("remember") && (wx.setStorageSync("xh", t), 
        wx.setStorageSync("pwd", o)), this.DoLogin(t, o)) : this.showMsg("账号或密码不能为空");
    },
    DoLogin: function(e, t) {
        ...
        o.setData({
            ...
            url: "https://score.withcic.cn/login",
            data: {
                xh: e,
                pwd: t
            },
    ...
    getScore: function(e, t) {
        var o = this;
        wx.request({
            url: "https://score.withcic.cn/getScore",
            data: {
                xh: e
            },
            method: "POST",
    ...
    changeSwitch: function(e) {
        wx.setStorageSync("remember", e.detail.value), e.detail.value ? (this.showMsg("账号信息仅存储于小程序本地，服务端不会做存储"), 
        this.setData({
            steps: 0
        })) : (wx.setStorageSync("xh", ""), wx.setStorageSync("pwd", ""));
    },
    ...
    onLoad: function(e) {
        var t = wx.getStorageSync("remember");
        if (t) {
            var o = wx.getStorageSync("xh"), a = wx.getStorageSync("pwd");
            this.setData({
                xh: o,
                pwd: a,
                remember: t
