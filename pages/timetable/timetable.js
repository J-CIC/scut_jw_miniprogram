...
Page({
    ...
    submitForm: function(e) {
        ...
        "" != t && "" != a ? (wx.getStorageSync("remember") && (wx.setStorageSync("xh", t), 
        wx.setStorageSync("pwd", a)), this.DoLogin(t, a)) : this.showMsg("账号或密码不能为空");
    },
    DoLogin: function(e, t) {
        ...
        a.setData({
            ...
            url: "https://score.withcic.cn/login3",
            data: {
                xh: e,
                pwd: t
            },
    ...
    onLoad: function(e) {
        ...
        if (t) {
            var a = wx.getStorageSync("xh"), o = wx.getStorageSync("pwd");
            this.setData({
                xh: a,
                pwd: o,
                remember: t
